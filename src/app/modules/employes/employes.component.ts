...
export class EmployesComponent {
  ...
  displayedColumns: string[] = ["id", "matricule", "nom", "prenom", "poste", "affectation", "telephone", "number","forfeit", "action"];
  ...
  deleteEmployee(id: number) {
    console.log(id);
    const check = window.confirm("est ce que vous etes sur de supprimer cet employé");
    if(check){
